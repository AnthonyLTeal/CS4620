...
class GumInterface
{
    ...
    private void CreateStartPanel()
    {
       ...
       // ButtonVisual Buttonvis = new ButtonVisual();
        //RoadPathButton.AddChild(Buttonvis);
        ...
        RoadPathButton.Click += (sender, args) =>
        {
            ...
            roadMesh.CreateEnabled = !roadMesh.CreateEnabled; 
                ...
                /*
                ColoredRectangleRuntime clickIndicator = new ColoredRectangleRuntime();
                Buttonvis.AddChild(clickIndicator);
                clickIndicator.Color = Microsoft.Xna.Framework.Color.Red;
                clickIndicator.Width = 12;
                clickIndicator.Height = 12;
                clickIndicator.Anchor(Anchor.Left);
                clickIndicator.X = 6;
                */
            
            
           // buttonVis.Background.Color = Color.Red;
            //https://docs.flatredball.com/gum/code/styling/code-only-styling/styling-individual-controls
        ...
        GraphWindowButton.Click += (sender, args) =>
        {
            ...
            Chart1Button.Click += (sender, args) =>
            {
                ...
                //Texture2D GraphTestImage = ImageLoader.LoadImage(graphicsDevice, "Graphs/Graph_20260409_083621.png");
                SpriteRuntime ChartSprite = new SpriteRuntime();
                // ChartSprite.RenderTargetTextureSource(GraphTestImage);
        ...
        runButton.Click += (sender, args) =>
        {
            ...
            SeedLabel.Text = "Percentage of rerouting cars (between 0 and 1)";
            SpawnPanel.AddChild(SeedLabel);
            TextBox SeedBox = new TextBox();
            SpawnPanel.AddChild(SeedBox);
            ...
            StartSimButton.Click += (sender, args) =>
                {
                    ...
                    if (int.TryParse(StaticAgentTextBox.Text, out staticCount) && int.TryParse(DynamicAgentTextBox.Text, out dynamicCount))
                    {
                        ...
                        runButton.RemoveFromRoot();

                        Button StopSimButton = new Button();
                        StopSimButton.Text = "Stop Simulation";
                        StartPanel.AddChild(StopSimButton);

                        StopSimButton.Click += (sender, args) =>
                        {
                            //code to end the simulation:
                            StopSimButton.RemoveFromRoot();
                            StartPanel.AddChild(runButton);
                        };
                    }
                    else
